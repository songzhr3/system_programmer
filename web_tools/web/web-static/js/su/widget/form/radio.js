...
$.su.Widget("radio", {
	...
	create: function(defaults, options){
		...
		me.each(function(i, obj){
			...
			container.prepend(input.addClass(this.allowChunk?"chunk":""));
		});
		...
		container.delegate("label.radio-label", "click", function(e){
			...
			var chunk_obj = $(this).closest("div.radio-group-container").find("input.chunk");
			if ($(this).is(":checked")){
				//$(this).addClass("selected");
				chunk_obj.radio("enable");
			}else{
				chunk_obj.radio("disableNoCheckbox");//checkbox需一直生效
