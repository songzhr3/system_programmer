...
$.su.Widget = function(name, options){
	...
	var fn = {
		...
		setTips: function(me, _tips){
			var me = me || this,
				container = me[name]("getContainer"),
				tipsContainer = (undefined != container) ? container.find("div.widget-tips div.tips-content") : undefined,
				tips = _tips[1] || "";
			if(me.get(0)){
				me.get(0).tips = tips;
			}
		...
		getChecked: function(me){
			var me = me || this,
				container = me.closest("div.widget-container");

			if (container.get(0)){
				var chkbox = container.find("input.checkbox-checkbox");
				if (chkbox.get(0)){
		...
		enableCheck: function(me){
			...
			if (container.get(0)){
				var chkbox = container.find("input.checkbox-checkbox");
				if (chkbox.get(0)){
					chkbox.removeClass("disabled").prop("disabled", false);
				}
			}
		},
		...
		show: function(me){
            ...
            }else if(container.hasClass("inline")){
