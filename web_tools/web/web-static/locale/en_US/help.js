(function($){
	...
	$.su.CHAR.HELP = {
		STATUS_INTERNET: {
			...
			CONTENT: [{
				type: "paragraph",
				content: "Displays relevant information <a href=\"javascript:void($.su.menu.advanced.goTo(\'wireless\'));\">click</a> about the Wide Area Network (Internet) connection."
			},{
				type: "title",
				title: "IPv4"
			},{
		...
		GUEST_NETWORK_WIRELESS:{	
			...
			CONTENT: [{
				...
				content:"Select the update interval of your Guest Network password."
			},{
				type: "name",
				title: "Security",
		...
		PARENTAL_CONTROL_DEVICES: {
			...
			CONTENT: [{
				...
				content: "Displays the restriction access time periods. The time schedule takes effect based on the router's system time which can be set in \"System Tools -> Time Settings\"."
			},{
				type: "name",
				title: "Description",
		...
		QOS_RULE: {
			...
			CONTENT: [{
				...
				content: [
					...
					"3. Select your desired application from the Application list, or you can customize an application by configuring the name, protocol and destination port (1-65535) in the corresponding fields, you can enter a single port or multiple ports or ports range, use commas to separate (e.g. 21,36-105,111).",
					"4. Click OK."
				]
			},{
				type: "step",
		...
		ADMIN_RECOVERY: {
			...
			CONTENT: [{
				...
				content: "It is highly recommended that you enable the Password Recovery feature, which will help reset your username and password via email."
			},{
				type: "name",
				title: "From",
				...
				type: "name",
				title: "SMTP Server",
				content: "Enter the SMTP server address that the router uses to send the verification code via email."
			},{
				type: "name",
				title: "Enable Authentication",
