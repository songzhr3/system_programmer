(function($){
	...
	$.su.CHAR = {
		...
		INDEX: {
			...
			CONFIRM_SAVE_CONFIG: 		    "Are you sure you want to save config?",
			...
			MODE_REBOOT_TIP: 				"Changing the operating mode will reboot the device, are you sure you want to continue?",
		...
		CONTROL: {
			...
			CONFIG_SATAYUS_NOT_SAVED:   "Config Not Saved",
			CONFIG_SATAYUS_SAVED:       "Config Saved",
			CONFIG_SATAYUS_SAVING:      "Config Saving",
			REBOOT: 					"Reboot"
		},
		...
		MENU: {
			...
			FUNCTION_KEEPALIVED:        "Standby Settings",
		...
		NAPT :{
                         MAPPING_LIST:"NAPT Rules",
                         ID:"ID",
                         NAME:"Rule Nmae",
                         IP_RANGE:"Source IP",
                         IP_RANGE_MASK:"Mask",
                         IP_HINT:"Should be IP addr",
                         IP_RANGE_HINT:"Should be at 0-24",
                         INTERFACE:"interface",
                         STATUS:"STATUS",
                         COMMENT:"NOTE",
                         ENABLE_THIS_ENTRY: "ON"
        },
		...
		G3_G4:{
			...
			PINLOCK_8:					"Another instance is running.",
		...
		OFFLINE_DOWNLOAD: {
			...
			STATUS:						"Status",
			DOWNLOAD:					"Download",
			REMAINTING:					"Remaining Time/Speed",
			TYPE:						"Type",	
			...
			SEED:						"Keep Seeding after task completed",
			UNIT:						"KB/S",
			MODIFY:						"Modify",
			PC:							"PC",
			USB:						"USB",
		...
		VPN:{
			...
			INSTALL_NOTE2: 				"Configure the OpenVPN server parameters (Service Type, Service Port and Client Access) and click Save.",
			...
			CONNECT_NOTICE:				"Before you configure the PPTP VPN server, please configure Dynamic DNS Service (recommended) or assign a static IP address for Wan port. And make sure System Time is correct.",
